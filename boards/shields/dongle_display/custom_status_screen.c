...
lv_obj_t *zmk_display_status_screen()
{
    ...
    lv_obj_align_to(zmk_widget_hid_indicators_obj(&hid_indicators_widget), zmk_widget_modifiers_obj(&modifiers_widget), LV_ALIGN_OUT_BOTTOM_RIGHT, 0, 0);
#endif
    ...
    if (CONFIG_ZMK_SCREEN_SIZE == 32)
        lv_obj_align(zmk_widget_dongle_battery_status_obj(&dongle_battery_status_widget), LV_ALIGN_TOP_LEFT, 35, 0);
    else
